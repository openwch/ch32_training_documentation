...
tmosEvents HAL_ProcessEvent(tmosTaskID task_id, tmosEvents events)
{
    ...
    if(events & HAL_KEY_EVENT)
    {
        ...
        tmos_start_task(halTaskID, HAL_KEY_EVENT, MS1_TO_SYSTEM_TIME(50));
    ...
    if(events & HAL_JOYSTICK_EVENT)
    {
        HAL_JoystickPressPercentageGet();
        tmos_start_task(halTaskID, HAL_JOYSTICK_EVENT, MS1_TO_SYSTEM_TIME(50));

        return events ^ HAL_JOYSTICK_EVENT;
    }
